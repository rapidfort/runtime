...
#### Deploy for SaaS
	rf-cmd --cmd install --rev 1.0.21-143 -h us01.rapidfort.com -u <username> -p <password>	

#### Deploy for On-Prem
	rf-cmd --cmd install --rev 1.0.21-143 -h <rf_host> -u <username> -p <password> -ru <registry-username> -rp <registry-password> 
